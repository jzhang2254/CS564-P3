...
void BTreeIndex::scanNext(RecordId& outRid) 
{
    ...
    if (currNode->keyArray[nextEntry] == INT_MAX or nextEntry == leafOccupancy) {
    ...
    // LeafNodeInt* currNode = (LeafNodeInt *) currentPageData;
	// if (currNode->ridArray[nextEntry].page_number == 0 or nextEntry == leafOccupancy-1) {
    //     // found page to read; look for sibling
    //     if (currNode->rightSibPageNo == 0) {
    //         throw IndexScanCompletedException();
    //     }
    ...
    // // if (leafOccupancy-1 == nextEntry or currNode->ridArray[nextEntry] == Page::INVALID_NUMBER) {
    // //     // found page to read; look for sibling
    // //     if (currNode->rightSibPageNo == Page::INVALID_NUMBER) {
    // //         throw IndexScanCompletedException();
    // //     }
    ...
    // //     // currentPageNum = currNode->rightSibPageNo;
	// // 	Page* nextPage;
	// // 	PageId nextPageId = currNode->rightSibPageNo[0];
	...
	// // 	currNode = (LeafNodeInt*)nextPage;
	// // 	// currentPageNum = currNode->rightSibPageNo[0];
